...
const appData = {
    ...
    "cards": [
        ...
        },
        {
            ...
            "q": "<h3>📋 实验7 官方任务书要求：</h3>\n<div class='taskbook-box' style='font-size: 0.92rem; background: rgba(59, 130, 246, 0.03); border: 1px dashed rgba(59, 130, 246, 0.25); padding: 12px; border-radius: 8px; margin-bottom: 1.5rem; line-height: 1.6;'>\n  <b>一、实验背景与目的</b>：理解工业 APP 与通用消费级 APP 的差异，掌握典型制造环节问题分析与需求定义方法，具备原型交互设计与表达能力。<br>\n  <b>二、实验核心任务</b>：\n  <ul style='margin-top: 6px; margin-bottom: 0; padding-left: 20px;'>\n    <li><b>任务 1：痛点分析</b> - 描述典型传统工作方式（纸质、电话、Excel），指出数据延迟/丢失、信息孤岛、缺乏闭环、决策滞后等至少三个实际痛点。</li>\n    <li><b>任务 2：核心功能定义</b> - 明确 APP 名称、使用角色、至少 4 项核心功能（每项须阐明 <b>输入-处理-输出</b> 逻辑），以及在数据采集方式、交互设计、异常处理上的关键差异。</li>\n    <li><b>任务 3：与传统方式对比优势</b> - 以表格或条目形式，从效率、准确性、实时性、可追溯性及协同能力等维度，对比该 APP 与传统方式的优势。</li>\n    <li><b>任务 4：原型界面与流程</b> - 设计 APP 主界面布局与至少一个关键流程的流转，阐述界面设计如何体现工业现场（如噪音、手套操作等）的使用交互特点。</li>\n  </ul>\n</div>\n\n<h3>✍️ 案例设计要求：</h3>\n请结合实验7的设计任务，设计一款“智能设备点检 APP”，并围绕上述四个核心任务完成系统性的设计与分析。",
            "tip": "<b>记忆口诀：设备点检掌上通，异常提报立跟踪，传统纸质化云雾，高效运维有神功</b>",
            "a": "<div class='sa-list'>\n  <div class='sa-item'>\n    <span class='sa-badge sa-badge-blue'>痛</span>\n    <div class='sa-content'>\n      <b class='sa-title'>一、痛点分析（传统工作方式：纸质点检表、电话报修、Excel台账登记）</b>\n      <span class='sa-desc'>\n        <ul>\n          <li><b>数据延迟与丢失（纸质表单弊端）</b>：操作工手写纸质单据，每天下班前统一录入Excel，导致数据存在8-24小时滞后，极易因油污污损或遗失而导致历史数据难以高效追溯；</li>\n          <li><b>信息孤岛与无法联动（缺乏动态监控）</b>：设备点检与实际PLC运行状态参数（如轴承振动频率、电机实时温度）彻底脱节，无法结合历史趋势做预测性维护，只能在设备停机后进行被动维修；</li>\n          <li><b>缺乏闭环监督（协同管理漏洞）</b>：异常通过口头电话或微信群简单报修，缺乏强流程约束，维修工响应速度与处理过程不透明，维保过程易产生漏错与遗漏。</li>\n        </ul>\n      </span>\n    </div>\n  </div>\n  \n  <div class='sa-item'>\n    <span class='sa-badge sa-badge-blue'>功</span>\n    <div class='sa-content'>\n      <b class='sa-title'>二、核心功能定义与逻辑（输入 → 处理 → 输出）</b>\n      <span class='sa-desc'>\n        ● <b>APP名称</b>：工业先锋-智能设备点检系统 APP<br>\n        ● <b>使用角色</b>：产线操作工（常规点检）、维修工程师（接收工单执行维保）、车间班组长（审核并调度派单）、厂区设备主管（查看设备健康度及综合报表）<br><br>\n        ● <b>4项核心功能（输入-处理-输出）</b>：\n        <ul>\n          <li><b>计划性常规点检</b>：<br>\n            - <i>输入</i>：设备上的 NFC 标签/二维码（通过手机传感器读取），获取当前点检任务与点检指标（如温度红线值 $60^\\circ\\text{C}$）。<br>\n            - <i>处理</i>：点检指标卡点比对逻辑。若工人在现场手动输入轴承温度为 $65^\\circ\\text{C}$，APP 立即触发异常卡点。<br>\n            - <i>输出</i>：生成待办任务卡，异常数据加红色标识，同时在后台自动生成待处置工单。\n          </li>\n          <li><b>异常现场报修</b>：<br>\n            - <i>输入</i>：现场故障拍照、语音录入以及异常严重等级选择。<br>\n            - <i>处理</i>：系统将故障特征（如“气缸不动作”）与设备知识库进行匹配，自动判定分流。<br>\n            - <i>输出</i>：在工单池中生成标准故障工单，并触发语音推送，发送至相应区域维修工的手机端。\n          </li>\n          <li><b>工单调度与维修响应</b>：<br>\n            - <i>输入</i>：待修工单队列，以及维修工程师的实时位置 and 在线状态。<br>\n            - <i>处理</i>：班组长手动指派或系统依据“就近原则+技能标签”算法自动完成最优匹配派工。<br>\n            - <i>输出</i>：派单指令即时推送至维修工APP，生成维修工的限时待办工单。\n          </li>\n          <li><b>维保指标数据看板</b>：<br>\n            - <i>输入</i>：一段时间内所有点检、维修及备件更换历史数据。<br>\n            - <i>处理</i>：聚合计算出设备整体的 $OEE$（综合设备效率）、$MTBF$（平均无故障时间）与 $MTTR$（平均修复时间）等指标。<br>\n            - <i>输出</i>：直观的 ECharts 柱状图、趋势折线图，生成导出 PDF 报告。\n          </li>\n        </ul>\n      </span>\n    </div>\n  </div>\n\n  <div class='sa-item'>\n    <span class='sa-badge sa-badge-blue'>异</span>\n    <div class='sa-content'>\n      <b class='sa-title'>三、与消费级 APP 的关键差异</b>\n      <span class='sa-desc'>\n        <ul>\n          <li><b>数据采集方式</b>：消费级APP主要依靠人工手动打字输入。而工业级APP强依赖硬件直连和现场物联设备，支持 NFC 现场刷卡防作弊签到、故障拍照直传、以及蓝牙传感器读取（如测振仪数据），甚至直接通过网关读取 PLC 的实时状态参数；</li>\n          <li><b>交互设计</b>：消费级APP追求精致细微、高密度信息排布和过渡动画。工业级APP则适配多噪、昏暗、高粉尘等严苛的工厂环境，采用高对比度红黄蓝状态底板，设计<b>超大触控热区按钮</b>（方便戴劳保手套操作），并强化语音交互与高强震动/光线警示；</li>\n          <li><b>异常处理机制</b>：消费级APP一般仅做普通的弹窗提示，忽略后不影响主流程。工业APP有极其严格的安全与管理卡点，检测到关键参数（如压力过载）越过红线时，系统必须强制锁定页面，在工单闭环处理且安全主管电子签名确认前，流程无法向下流转。</li>\n        </ul>\n      </span>\n    </div>\n  </div>\n\n  <div class='sa-item'>\n    <span class='sa-badge sa-badge-blue'>优</span>\n    <div class='sa-content'>\n      <b class='sa-title'>四、与传统方式对比优势</b>\n      <span class='sa-desc'>\n        <ul>\n          <li><b>效率（Efficiency）</b>：传统方式纸质单据逐级手写签字、下班后重复录入，流程滞后 12-24 小时；APP 实现一键扫码签到，工单秒级直达，流程零延迟。</li>\n          <li><b>准确性（Accuracy）</b>：传统方式凭主观记忆估算，容易抄错数字或产生“漏点假检”；APP 内置数值红线自动检测，漏检智能拦截，保证 100% 数据真实可靠。</li>\n          <li><b>实时性（Real-time）</b>：传统方式事后看台账报表，故障被动响应；APP 数据实时上传，报警毫秒级推送，大幅减少非计划停机时间。</li>\n          <li><b>可追溯性（Traceability）</b>：传统纸质档案难以分类检索，甚至可能被故意篡改；APP 所有点检记录包含“NFC定位+签名+不可修改时间戳”，形成永久数字凭证，有据可查。</li>\n          <li><b>协同能力（Collaboration）</b>：传统三方信息严重脱节，沟通成本极高；APP 建立统一的协同平台，维保进度全员透明，工单闭环处理。</li>\n        </ul>\n      </span>\n    </div>\n  </div>\n\n  <div class='sa-item'>\n    <span class='sa-badge sa-badge-blue'>型</span>\n    <div class='sa-content'>\n      <b class='sa-title'>五、原型界面设计与工业现场交互特色</b>\n      <span class='sa-desc'>\n        <ul>\n          <li><b>主界面布局规划</b>：头部显示操作工个人状态（点检中/待命）与厂区综合指数。中部采用卡片式待办列表（NFC未刷卡显示灰色锁，刷卡后解锁变为亮绿色）。底部设计四大超大核心标签（工作台、异常报修、备用查询、我的报表）；</li>\n          <li><b>关键操作流程流转</b>：操作工<code>扫码/NFC验证</code> → <code>解锁当前点检表</code> → <code>输入数据超界（触发红色感叹号）</code> → <code>调用相机故障图直传</code> → <code>点击黄色一键提报按钮</code> → <code>生成待办工单并流转至维修工</code>；</li>\n          <li><b>离线容错能力</b>：当工人进入钢筋密布或地下无信号的车间时，APP 自动切换至离线模式。数据保存在本地 IndexedDB 数据库中，一旦检测到网络恢复，系统自动断点续传。</li>\n        </ul>\n      </span>\n    </div>\n  </div>\n</div>"
}
    ]
},
    // === 模块 1：导数公式 ===
      ...
      "cards": [
        {
          ...
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>即</span>    <div class='sa-content'><b class='sa-title'>即开即用</b>：<span class='sa-desc'>无需下载与安装，通过扫码或搜索即可瞬间打开应用。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>走</span>    <div class='sa-content'><b class='sa-title'>用完即走</b>：<span class='sa-desc'>关闭后不占用手机存储空间，也不驻留后台进程。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>低</span>    <div class='sa-content'><b class='sa-title'>开发成本低</b>：<span class='sa-desc'>提供统一的开发框架和组件，比原生APP更容易上手。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>融</span>    <div class='sa-content'><b class='sa-title'>微信生态融合</b>：<span class='sa-desc'>深度打通微信支付、社交分享、客服与登录等微信特有生态。</span></div>  </div></div>"
        },
        {
          "title": "第1章：项目创建过程",
          "q": "请简述微信小程序项目的创建过程。",
          "tip": "<b>记忆口诀：【先申账号拿AppID，下载工具建新项目】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>号</span>    <div class='sa-content'><b class='sa-title'>获取AppID</b>：<span class='sa-desc'>在微信公众平台注册小程序账号，并在“开发管理-开发设置”中复制AppID。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>工</span>    <div class='sa-content'><b class='sa-title'>下载工具</b>：<span class='sa-desc'>下载并安装对应系统版本的“微信开发者工具”。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>建</span>    <div class='sa-content'><b class='sa-title'>新建项目</b>：<span class='sa-desc'>启动开发者工具，扫码登录，点击“+”号选择新建小程序项目。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>配</span>    <div class='sa-content'><b class='sa-title'>配置信息</b>：<span class='sa-desc'>填入项目名称、选择本地目录、填入AppID，选择开发模式（小程序）及模板，点击确定生成。</span></div>  </div></div>"
        },
        {
          "title": "第2章：WXML与HTML的区别",
          "q": "简述 WXML 和 HTML 的区别。",
          "tip": "<b>记忆口诀：【标签组件大换血，数据绑定不用DOM】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>标</span>    <div class='sa-content'><b class='sa-title'>标签不同</b>：<span class='sa-desc'>HTML使用div/span/img，WXML使用专属组件view/text/image。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>绑</span>    <div class='sa-content'><b class='sa-title'>数据绑定</b>：<span class='sa-desc'>WXML支持MVVM式的双括号“{{ }}”插值，而HTML需要通过JS手动操作DOM。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>控</span>    <div class='sa-content'><b class='sa-title'>指令渲染</b>：<span class='sa-desc'>WXML拥有指令属性（如wx:if、wx:for），HTML本身不具备逻辑控制能力。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>空</span>    <div class='sa-content'><b class='sa-title'>没有DOM树</b>：<span class='sa-desc'>WXML中没有HTML的window和document对象，无法进行标准的DOM操作。</span></div>  </div></div>"
        },
        {
          "title": "第2章：WXSS与CSS的区别",
          "q": "简述 WXSS 和 CSS 的区别。",
          "tip": "<b>记忆口诀：【rpx适配全屏幕，import导入相对路】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>尺</span>    <div class='sa-content'><b class='sa-title'>rpx单位</b>：<span class='sa-desc'>新增rpx（responsive pixel）响应式像素单位，屏幕宽度固定为750rpx，自动适配不同机型。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>导</span>    <div class='sa-content'><b class='sa-title'>样式导入</b>：<span class='sa-desc'>提供@import语法，支持将外联样式表引入到当前样式表中。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>选</span>    <div class='sa-content'><b class='sa-title'>选择器受限</b>：<span class='sa-desc'>WXSS仅支持常用的选择器（如.class、#id、element等），不支持一些复杂的CSS3选择器。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>局</span>    <div class='sa-content'><b class='sa-title'>全局与局部</b>：<span class='sa-desc'>拥有app.wxss全局样式与页面专属wxss，页面样式会自动覆盖同名的全局样式。</span></div>  </div></div>"
        },
        {
          "title": "第2章：Flex布局概念",
          "q": "简述 Flex 布局的概念。",
          "tip": "<b>记忆口诀：【设为flex分双轴，对齐伸缩排版优】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>容</span>    <div class='sa-content'><b class='sa-title'>弹性容器</b>：<span class='sa-desc'>通过将父元素的display属性设为flex，使其成为Flex容器，其子元素自动成为Flex项目。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>轴</span>    <div class='sa-content'><b class='sa-title'>双轴模型</b>：<span class='sa-desc'>由主轴（main axis）和交叉轴（cross axis）组成，通过flex-direction可以调整轴向。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>对</span>    <div class='sa-content'><b class='sa-title'>对齐控制</b>：<span class='sa-desc'>使用justify-content定义项目在主轴的对齐方式，使用align-items定义在交叉轴的对齐方式。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>伸</span>    <div class='sa-content'><b class='sa-title'>弹性伸缩</b>：<span class='sa-desc'>子项目可通过flex属性控制自身的放大、缩小比例及基础大小，实现自动按比例分配。</span></div>  </div></div>"
        },
        {
          "title": "第3章：页面生命周期",
          "q": "简述页面生命周期函数包括哪些。",
          "tip": "<b>记忆口诀：【加载显示初渲染，隐藏卸载生命完】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>载</span>    <div class='sa-content'><b class='sa-title'>onLoad(query)</b>：<span class='sa-desc'>页面加载时触发。一个页面只调用一次，可以在此获取打开当前页面所调用的参数。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>显</span>    <div class='sa-content'><b class='sa-title'>onShow()</b>：<span class='sa-desc'>页面显示/切入前台时触发。每次打开页面或从后台切回前台都会执行。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>初</span>    <div class='sa-content'><b class='sa-title'>onReady()</b>：<span class='sa-desc'>页面初次渲染完成时触发。一个页面只调用一次，代表页面可以与视图层进行交互。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>隐</span>    <div class='sa-content'><b class='sa-title'>onHide()</b>：<span class='sa-desc'>页面隐藏/切入后台时触发。如wx.navigateTo跳转或微信切入后台。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>卸</span>    <div class='sa-content'><b class='sa-title'>onUnload()</b>：<span class='sa-desc'>页面卸载时触发。如wx.redirectTo重定向或wx.navigateBack返回上一页。</span></div>  </div></div>"
        },
        {
          "title": "第3章：wx:if与hidden区别",
          "q": "简述 wx:if 控制属性和 hidden 属性的区别。",
          "tip": "<b>记忆口诀：【条件if控渲染，频繁显隐hidden连】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>机</span>    <div class='sa-content'><b class='sa-title'>渲染机制</b>：<span class='sa-desc'>wx:if是动态的销毁和重建组件；hidden仅通过修改CSS的display属性控制可见性。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>初</span>    <div class='sa-content'><b class='sa-title'>初始负载</b>：<span class='sa-desc'>wx:if是惰性的，初始为false则不渲染；hidden不管初始值，都会进行组件渲染。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>销</span>    <div class='sa-content'><b class='sa-title'>生命周期</b>：<span class='sa-desc'>wx:if切换时会触发子组件的创建与销毁生命周期；hidden不会影响组件生命周期状态。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>选</span>    <div class='sa-content'><b class='sa-title'>场景选择</b>：<span class='sa-desc'>频繁切换使用hidden以减少渲染开销；条件不常改变的使用wx:if以减少初始渲染时间。</span></div>  </div></div>"
        },
        {
          "title": "第3章：下拉刷新实现",
          "q": "简述微信小程序如何实现下拉刷新。",
          "tip": "<b>记忆口诀：【配置开启Refresh，监听重置stop止】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>配</span>    <div class='sa-content'><b class='sa-title'>开启全局/页面配置</b>：<span class='sa-desc'>在app.json或具体页面的json配置文件中，设置\"enablePullDownRefresh\": true。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>听</span>    <div class='sa-content'><b class='sa-title'>监听下拉事件</b>：<span class='sa-desc'>在页面的JS文件中，编写生命周期函数onPullDownRefresh()，在里面编写刷新逻辑。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>新</span>    <div class='sa-content'><b class='sa-title'>更新页面数据</b>：<span class='sa-desc'>在监听事件内重新请求API，并将获取的最新数据通过this.setData()渲染至页面。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>停</span>    <div class='sa-content'><b class='sa-title'>主动停止动画</b>：<span class='sa-desc'>数据加载完成后，必须手动调用wx.stopPullDownRefresh()，否则下拉加载动画不会自动消失。</span></div>  </div></div>"
        },
        {
          "title": "第3章：上拉触底实现",
          "q": "简述微信小程序如何实现上拉触底。",
          "tip": "<b>记忆口诀：【触底监听onReach，配置距离加防重】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>距</span>    <div class='sa-content'><b class='sa-title'>配置触底距离</b>：<span class='sa-desc'>在页面json配置中，可通过onReachBottomDistance设置触发触底的距离，单位px，默认为50px。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>听</span>    <div class='sa-content'><b class='sa-title'>监听触底函数</b>：<span class='sa-desc'>在页面的JS文件中，重写onReachBottom()生命周期函数，在该函数中编写加载下一页数据的逻辑。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>拼</span>    <div class='sa-content'><b class='sa-title'>追加合并数据</b>：<span class='sa-desc'>发送请求获取新一页的数据后，使用this.setData()将新数据拼接到原数据列表的末尾。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>锁</span>    <div class='sa-content'><b class='sa-title'>加入防抖节流</b>：<span class='sa-desc'>设置状态锁（如isloading），在请求发送时加锁，请求结束解锁，防止用户多次上拉重复请求。</span></div>  </div></div>"
        },
        {
          "title": "第4章：背景音频管理",
          "q": "简述 BackgroundAudioManager 实例的属性和方法。",
          "tip": "<b>记忆口诀：【获取实例配src，Title必填play起】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>取</span>    <div class='sa-content'><b class='sa-title'>获取实例</b>：<span class='sa-desc'>通过wx.getBackgroundAudioManager()获取系统级唯一的背景音频播放管理器。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>属</span>    <div class='sa-content'><b class='sa-title'>核心属性</b>：<span class='sa-desc'>src属性（音频源链接）、title属性（音频标题，必须设置否则无法播放）、duration（总时长）、currentTime（当前播放进度）。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>方</span>    <div class='sa-content'><b class='sa-title'>核心方法</b>：<span class='sa-desc'>play()开始播放、pause()暂停播放、stop()停止播放、seek(position)音频进度跳转。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>听</span>    <div class='sa-content'><b class='sa-title'>状态监听</b>：<span class='sa-desc'>onPlay()监听播放开始、onPause()监听播放暂停、onTimeUpdate()监听播放进度更新、onEnded()监听播放自然结束。</span></div>  </div></div>"
        },
        {
          "title": "第4章：Canvas绘图步骤",
          "q": "简述使用画布 API 进行绘图的基本步骤。",
          "tip": "<b>记忆口诀：【获取上下文设样式，路径绘制draw出来】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>创</span>    <div class='sa-content'><b class='sa-title'>获取画布上下文</b>：<span class='sa-desc'>在WXML定义canvas组件，通过wx.createSelectorQuery()获取节点并调用getContext('2d')获取绘图上下文（Canvas 2D标准）。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>设</span>    <div class='sa-content'><b class='sa-title'>设置绘制样式</b>：<span class='sa-desc'>通过上下文设置样式，如fillStyle（填充色）、strokeStyle（线条色）、lineWidth（线宽）及font（字体样式）等。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>绘</span>    <div class='sa-content'><b class='sa-title'>绘制图形与路径</b>：<span class='sa-desc'>调用moveTo()、lineTo()、arc()等勾勒路径，或使用fillRect()、strokeRect()、fillText()等直接输出图形与文本。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>画</span>    <div class='sa-content'><b class='sa-title'>渲染生成</b>：<span class='sa-desc'>若是旧版Canvas API，绘制完毕后必须调用ctx.draw()方法完成实际的画布渲染；若使用Canvas 2D则无需draw()，为实时绘制。</span></div>  </div></div>"
        },
        {
          "title": "第4章：文件上传与下载",
          "q": "简述如何实现文件上传和文件下载。",
          "tip": "<b>记忆口诀：【选好图片upload，远程下载download传】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>上</span>    <div class='sa-content'><b class='sa-title'>文件上传方法</b>：<span class='sa-desc'>先调用wx.chooseMedia选择本地多媒体文件，获取tempFilePath，再通过wx.uploadFile()上传，需要指定url、filePath和name等参数。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>下</span>    <div class='sa-content'><b class='sa-title'>文件下载方法</b>：<span class='sa-desc'>调用wx.downloadFile()方法，指定文件url。下载成功后会在回调中返回临时文件路径tempFilePath。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>存</span>    <div class='sa-content'><b class='sa-title'>文件保存与打开</b>：<span class='sa-desc'>拿到下载的临时文件后，可用wx.saveFile()将其持久化保存到本地，或者用wx.openDocument()直接打开预览（如PDF/Word文档）。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>听</span>    <div class='sa-content'><b class='sa-title'>进度条监听</b>：<span class='sa-desc'>wx.uploadFile和wx.downloadFile会返回任务实例，通过监听onProgressUpdate事件可以获取实时进度百分比。</span></div>  </div></div>"
        },
        {
          "title": "第5章：Animation实例获取",
          "q": "简述如何获取 Animation 实例。",
          "tip": "<b>记忆口诀：【createAnimation定参数，step结束export出】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>创</span>    <div class='sa-content'><b class='sa-title'>调用创建API</b>：<span class='sa-desc'>通过wx.createAnimation(Object)创建一个动画实例。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>参</span>    <div class='sa-content'><b class='sa-title'>配置动画参数</b>：<span class='sa-desc'>可在Object中配置duration(过渡时间)、timingFunction(动画效果)、delay(延迟)和transformOrigin(变形原点)。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>链</span>    <div class='sa-content'><b class='sa-title'>编写动画步骤</b>：<span class='sa-desc'>通过链式调用如rotate()、scale()等，最后调用step()表示这组动画定义完毕。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>导</span>    <div class='sa-content'><b class='sa-title'>导出并绑定</b>：<span class='sa-desc'>通过animation.export()导出动画数据，使用this.setData()绑定到页面的Data中，并放入WXML的animation属性里。</span></div>  </div></div>"
        },
        {
          "title": "第5章：应用生命周期",
          "q": "简述微信小程序中应用生命周期回调函数 onLaunch( )、onShow( )、onError( )、onHide( )和 onPageNotFound( ) 的作用。",
          "tip": "<b>记忆口诀：【初始化时onLaunch，显示隐藏错丢失】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>启</span>    <div class='sa-content'><b class='sa-title'>onLaunch()</b>：<span class='sa-desc'>生命周期-监听小程序初始化。小程序初始化完成时触发，全局只触发一次。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>显</span>    <div class='sa-content'><b class='sa-title'>onShow()</b>：<span class='sa-desc'>生命周期-监听小程序启动或切前台。当小程序启动，或从后台进入前台显示时触发。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>隐</span>    <div class='sa-content'><b class='sa-title'>onHide()</b>：<span class='sa-desc'>生命周期-监听小程序切后台。当小程序从前台进入后台隐藏时触发。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>错</span>    <div class='sa-content'><b class='sa-title'>onError()</b>：<span class='sa-desc'>错误监听函数。小程序脚本发生JS错误，或者API调用失败时触发，用于收集错误日志。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>失</span>    <div class='sa-content'><b class='sa-title'>onPageNotFound()</b>：<span class='sa-desc'>页面不存在监听函数。小程序要打开的页面不存在时触发，可在函数内重定向到首页，避免白屏。</span></div>  </div></div>"
        },
        {
          "title": "第5章：WebSocket连接",
          "q": "简述如何创建 WebSocket 连接。",
          "tip": "<b>记忆口诀：【connectSocket连网络，onOpen成功发消息】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>连</span>    <div class='sa-content'><b class='sa-title'>发起连接</b>：<span class='sa-desc'>调用wx.connectSocket()方法，传入wss协议的安全域名接口URL，返回SocketTask实例。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>听</span>    <div class='sa-content'><b class='sa-title'>监听开启</b>：<span class='sa-desc'>使用wx.onSocketOpen()或SocketTask.onOpen()监听连接成功建立的事件。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>发</span>    <div class='sa-content'><b class='sa-title'>发送数据</b>：<span class='sa-desc'>在连接成功建立后，调用wx.sendSocketMessage()或SocketTask.send()传输文本或二进制数据。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>收</span>    <div class='sa-content'><b class='sa-title'>接收与关闭</b>：<span class='sa-desc'>调用wx.onSocketMessage()实时监听服务端消息，在断开或退出时调用wx.closeSocket()关闭长连接。</span></div>  </div></div>"
        },
        {
          "title": "第6章：页面切换方法区别",
          ...
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>保</span>    <div class='sa-content'><b class='sa-title'>wx.navigateTo</b>：<span class='sa-desc'>保留当前页，跳转至非TabBar页。原页面不销毁，可以使用wx.navigateBack()返回，页面栈上限为10层。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>销</span>    <div class='sa-content'><b class='sa-title'>wx.redirectTo</b>：<span class='sa-desc'>关闭当前页，跳转至非TabBar页。原页面会被销毁出栈，常用于表单提交成功或登录重定向，无法返回原页。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>切</span>    <div class='sa-content'><b class='sa-title'>wx.switchTab</b>：<span class='sa-desc'>专门用于跳转至TabBar指定的底部导航页。跳转时会关闭并销毁页面栈中所有其他非TabBar页面。</span></div>  </div></div>"
        },
        {
          "title": "第6章：小程序登录流程",
          "q": "简述微信小程序的登录流程。",
          "tip": "<b>记忆口诀：【login拿code，后台换openid，token回传保本地】</b>",
          "a": "<div class='sa-list'>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>凭</span>    <div class='sa-content'><b class='sa-title'>前端获取Code</b>：<span class='sa-desc'>小程序端调用wx.login()获取临时登录凭证code，有效期为5分钟。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>传</span>    <div class='sa-content'><b class='sa-title'>发送凭证至后台</b>：<span class='sa-desc'>小程序通过wx.request()将code发送给开发者自建服务器。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>换</span>    <div class='sa-content'><b class='sa-title'>后台向微信换密钥</b>：<span class='sa-desc'>开发者服务器向微信接口服务发送code+AppID+AppSecret，换取用户的openid和会话密钥session_key。</span></div>  </div>  <div class='sa-item'>    <span class='sa-badge sa-badge-emerald'>存</span>    <div class='sa-content'><b class='sa-title'>返回并保存Token</b>：<span class='sa-desc'>服务器生成自定义登录态（Token）返给前端，前端调用wx.setStorage缓存Token，后续请求携带Token。</span></div>  </div></div>"
        }
      ]
    },
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                lecture: appData.mcu_cases,
                quiz: appData.mcu_quiz,
                flashcard: appData.mcu_points
            }
        ]
    }
];
        ...
        mcu_quiz: {
            ...
            cards: [
                ...
                },
                {
                    ...
                    a: `<div class='sa-list'>
  <div class='sa-item'>
    <span class='sa-badge sa-badge-emerald'>1</span>
    <div class='sa-content'>
      <b class='sa-title'>GPIO_InitTypeDef (引脚配置)</b>
      <span class='sa-desc'>成员：<code>GPIO_Pin</code>(引脚标号), <code>GPIO_Speed</code>(速度，如50MHz), <code>GPIO_Mode</code>(模式，如Out_PP推挽输出)</span>
    </div>
  </div>
  <div class='sa-item'>
    <span class='sa-badge sa-badge-emerald'>2</span>
    <div class='sa-content'>
      <b class='sa-title'>TIM_TimeBaseInitTypeDef (定时器基础)</b>
      <span class='sa-desc'>成员：<code>TIM_Period</code>(ARR自动重装值), <code>TIM_Prescaler</code>(PSC预分频), <code>TIM_CounterMode</code>(计数模式，如向上)</span>
    </div>
  </div>
  <div class='sa-item'>
    <span class='sa-badge sa-badge-emerald'>3</span>
    <div class='sa-content'>
      <b class='sa-title'>TIM_OCInitTypeDef (PWM输出比较)</b>
      <span class='sa-desc'>成员：<code>TIM_OCMode</code>(模式，如PWM1), <code>TIM_OutputState</code>(输出使能), <code>TIM_Pulse</code>(CCR占空比值), <code>TIM_OCPolarity</code>(输出极性)</span>
    </div>
  </div>
  <div class='sa-item'>
    <span class='sa-badge sa-badge-emerald'>4</span>
    <div class='sa-content'>
      <b class='sa-title'>NVIC_InitTypeDef (中断向量控制)</b>
      <span class='sa-desc'>成员：<code>NVIC_IRQChannel</code>(中断通道), <code>NVIC_IRQChannelPreemptionPriority</code>(抢占优先级), <code>NVIC_IRQChannelSubPriority</code>(响应优先级), <code>NVIC_IRQChannelCmd</code>(使能)</span>
    </div>
  </div>
  <div class='sa-item'>
    <span class='sa-badge sa-badge-emerald'>5</span>
    <div class='sa-content'>
      <b class='sa-title'>EXTI_InitTypeDef (外部中断)</b>
      <span class='sa-desc'>成员：<code>EXTI_Line</code>(中断线), <code>EXTI_Mode</code>(模式：中断/事件), <code>EXTI_Trigger</code>(触发边沿：上升沿/下降沿), <code>EXTI_LineCmd</code>(使能)</span>
    </div>
  </div>
</div>`
                }
    ...
    if (majorCategory) {
        ...
        if (mcuCourse) {
            mcuCourse.lecture = appData.mcu_cases;
            mcuCourse.quiz = appData.mcu_quiz;
            mcuCourse.flashcard = appData.mcu_points;
        }
    }
...
(function optimizeExamFlashcardsForMemory() {
    const asCards = module => Array.isArray(module?.cards) ? module.cards : [];
  ...
  <div class='sa-item'>
    ...
    applyIndexedTips(asCards(appData.ia_short_answers), [
        ...
        ["人机物先两元，信息加入成HCPS", ["传统制造看人和物理系统", "数字化制造加入信息系统", "网络化、智能化是在HCPS上继续增强"]],
        ["大跨群混四智能，感知识别到决策", ["大数据智能：从海量数据挖规律", "跨媒体智能：看图、听音、懂文本", "群体智能：多主体协作", "混合增强智能：人机互补"]],
        ["场感监生业，五层金字塔", ["场设备层是底座", "感知层采数据", "监控控制层管过程", "生产管控层排计划", "业务运营层管经营"]],
        ["数字算逻辑，集成缩芯片", ["数字电路处理0和1", "集成电路把海量元件做进芯片", "共同作用：小体积、低功耗、高性能"]],
        ["光刻刻图形，刻蚀去材料，掺杂改性能", ["三步顺序记：光刻、刻蚀、掺杂", "问工序时先答名称，再补各自作用"]],
        ["通用专用可编程，工业芯片重可靠", ["通用：MCU、DSP、CPU、GPU、存储器", "专用：ASIC", "其他：FPGA、MEMS", "工业环境强调稳定、可靠、寿命长"]],
        ["程序数据文档，三件合成软件", ["程序负责执行", "数据是处理对象", "文档说明使用、维护和设计"]],
        ["系统管资源，支撑帮开发，应用解问题", ["系统软件：CPU、内存、设备、文件管理", "支撑软件：工具和开发环境", "应用软件：面向具体业务场景"]],
        ["设控管维四类工业软件", ["研发设计：CAD、CAE、PLM", "生产控制：MES、SCADA、DCS", "经营管理：ERP、SCM、CRM", "运维服务：MRO、PHM"]],
        ["集中共享防冗余，安全一致好查询", ["数据库集中管理数据", "重点解决共享、独立、冗余、安全、一致性问题"]],
        ["建模查询并并发，恢复安全五关键", ["数据建模", "查询处理", "事务并发", "故障恢复", "安全与完整性"]],
        ["敏转换处理算，传感四件套", ["敏感元件感受被测量", "转换元件变成电信号", "处理电路放大滤波", "计算单元分析输出"]],
        ["力流温位湿，五类信号取", ["力：应变、压电等", "流量：伯努利、热耗散", "温度：接触/非接触", "位移：光栅等", "湿度：湿敏电阻/电容"]],
        ["转换调理估误差，三步保信号", ["转换：调制解调、A/D", "调理：放大、滤波", "估计：递归/非递归降低误差"]],
        ["压力液位光，工业三现场", ["压力传感看压阻/应变", "液位传感分接触/非接触", "光传感常用于视觉和检测"]],
        ["检A控D驱对象，数字控制一条链", ["检测装置采集", "A/D进控制器", "D/A出控制量", "驱动执行机构作用于对象"]],
        ["P看现在快，I管过去准，D预未来稳", ["比例P提高响应速度", "积分I消除稳态误差", "微分D预测趋势、改善稳定"]],
        ["数控PLC和DCS，APC更先进", ["CNC控制机床", "PLC做逻辑控制", "DCS管过程分布控制", "APC做高级过程优化"]],
        ["数字通信抗干扰，频带设备是代价", ["优点：抗干扰、纠错、加密、集成", "缺点：频带宽、设备复杂、同步要求高"]],
        ["源编信编调信道，解调译码到信宿", ["发送端：信源、信源编码、信道编码、调制", "传输中：信道", "接收端：解调、信道译码、信源译码、信宿"]],
        ["同轴高频双绞便，光纤大容量抗干扰", ["同轴：高频、抗干扰但笨重", "双绞线：便宜、轻便、常用于局域网", "光纤：容量大、距离远、保密好"]],
        ["蜂窝广，WLAN近，物联省，短距灵", ["蜂窝移动通信覆盖广", "WLAN用于局域接入", "NB-IoT/LoRa低功耗大连接", "蓝牙、Zigbee、UWB、RFID短距离"]],
        ["物链网传会表应，七层从下往上背", ["物理传比特", "链路成帧", "网络选路", "传输端到端", "会话建连接", "表示转格式", "应用给服务"]],
        ["TCP/IP打底，SDN/NFV软化，5G高速低延", ["TCP/IP是互联网基础协议", "SDN控制与转发分离", "NFV用通用硬件承载网络功能", "5G支持高速、低时延、大连接"]],
        ["地址域名找位置，标识解析找对象", ["IP与DNS解决主机定位", "标识解析解决物联网对象和资源定位"]],
        ["TSN三低一同步，工业实时靠调度", ["低时延", "低抖动", "低丢失", "时间同步、数据调度、帧整形"]],
        ["云端拆任务，多机算结果", ["云计算本质是分布式计算", "把大任务拆成小任务", "多服务器协同处理并返回结果"]],
        ["边缘靠近源头，少传快反应", ["计算、存储、网络下沉到边缘侧", "适合实时控制、低时延和本地处理"]],
        ["虚拟管控云网边，分布架构凑三件", ["虚拟化及管理", "云网边技术", "分布式架构技术"]],
        ["资源抽象再切分，一机可变多逻辑", ["抽象CPU、内存、存储、网络", "分割重组提高利用率", "不同逻辑机相互隔离"]],
        ["管虚管实管数据，运维流程变简单", ["对接虚拟化环境和实体硬件", "管理资源、分析数据", "简化运维"]],
        ["4V背四字：量、多、快、变", ["Volume数据量大", "Variety类型多", "Velocity生成快", "Variability复杂多变"]],
        ["采存算用四板块，数据一路变价值", ["采集拿数据", "存储管数据", "计算处理数据", "应用产生价值"]],
        ["资产威胁措施，安全三要素", ["保护硬件、软件、数据", "防破坏、防篡改、防泄露", "保证服务连续可靠"]],
        ["防护检测响应修复，安全闭环三段式", ["防护技术挡风险", "检测技术找风险", "响应修复消风险"]],
        ["去中心共维护，共识存储难篡改", ["区块链是多方共同维护的数据管理技术", "许可链看授权，非许可链开放加入"]],
        ["密码对等共识合约存储，五核技术", ["密码算法保安全", "对等网络连节点", "共识算法保一致", "智能合约可执行", "数据存储可容错"]],
        ["深迁强大四分支，大数据智能靠深学", ["DL是核心", "TL迁移", "RL强化", "大模型处理海量知识"]],
        ["输入隐藏输出，参数学习映射", ["输入层接收数据", "隐藏层学习特征", "输出层给结果"]],
        ["先感知后认知，跨媒体能看听懂", ["感知：视觉、语音等", "认知：知识图谱、推理等"]],
        ["个体联网协作，群体超过单体", ["基于互联网组织大量个体", "共同完成计算或决策任务"]],
        ["仿自然群体，促AI创新和应用", ["推动理论技术创新", "为应用、管理、商业创新提供能力"]],
        ["数据不出门，参数来联邦", ["本地数据不交换", "只交换模型参数或中间结果", "兼顾协同训练和隐私保护"]],
        ["自感自学自执行，自决自适工业智", ["工业智能是AI与工业融合", "五自特征：感知、学习、执行、决策、适应"]],
        ["研产生管服，降增提减四效果", ["研发、生产、管理、服务全环节应用", "目标：降本、增效、提质、减排"]],
        ["虚拟双胞胎，全生命周期数据通", ["虚拟空间建数字模型", "覆盖全生命周期信息", "和物理实体持续数据交流"]],
        ["虚数连物四要素，孪生系统这样搭", ["虚拟实体", "孪生数据", "连接", "物理实体"]],
        ["痛功异优型，工业APP大题五段答", ["痛点分析", "核心功能和输入-处理-输出", "与消费级APP差异", "与传统方式优势", "原型界面与流程"]]
    ]);

    const seHighFreq = new Set([0, 1, 2, 3, 4, 5, 6, 7, 8]);
    applyIndexedTips(asCards(appData.se_short_answers), [
        ["定义目的原则三连，早测抓错不穷尽", ["定义：验证是否满足需求并发现差异", "目的：找缺陷、评质量、降风险", "原则：尽早测、不穷尽、缺陷集群、杀虫剂效应"], "高频考点：概念题和判断题都爱考"],
        ["需计设执评告，测试流程一条道", ["需求分析", "制定计划", "设计用例", "执行并提交缺陷", "质量评估", "总结报告"], "高频考点：流程顺序很容易考"],
        ["黑盒不看代码，等价边界因果错", ["等价类：代表性数据", "边界值：刚好、刚外、刚内", "因果图/决策表：条件组合", "错误推测：经验补漏"], "高频考点：黑盒方法名称必背"],
        ["恒非或与四关系，互含唯一要求屏", ["因果关系：恒等、非、或、与", "输入约束：互斥E、包含I、唯一O、要求R", "输出约束：屏蔽M"], "高频考点：字母约束最容易混"],
        ["列条件定动作，填规则再合并", ["列条件桩和动作桩", "填真假组合和动作项", "合并无影响规则", "每列规则转用例"], "高频考点：常以简答题出现"],
        ["接口不看页面，看请求和响应", ["读接口文档", "设计用例和数据", "发送请求", "验状态码、格式、业务字段", "缺陷跟踪和回归"], "高频考点：接口流程、原理、报文一起背"],
        ["GET查POST建，PUT整改PATCH片，DELETE删HEAD头", ["GET安全幂等查资源", "POST提交或新建", "PUT整体替换", "PATCH局部修改", "DELETE删除", "HEAD只要响应头"], "高频考点：方法作用常考选择题"],
        ["ID名类标链部，XPath和CSS收尾", ["id", "name", "class name", "tag name", "link text", "partial link text", "XPath", "CSS selector"], "高频考点：八大定位方式直接默写"],
        ["容装能网插电流，App专项六件套", ["兼容性", "安装/卸载/升级", "性能资源", "网络强弱无网", "交叉事件/中断", "电量与流量"], "高频考点：移动端测试必背"]
    ]);
    asCards(appData.se_short_answers).forEach((card, index) => {
        card.highFreq = seHighFreq.has(index);
        card.examTag = card.highFreq ? "高频考点" : "常规考点";
    });

    const wxHighFreq = new Set([0, 1, 2, 3, 4, 5, 6, 7, 8, 13, 15, 16]);
    applyIndexedTips(asCards(appData.wx_short_answers), [
        ["即开即走省空间，微信生态低成本", ["无需安装", "入口轻", "不长期占空间", "微信生态能力丰富"], "高频考点：特点题常考简答"],
        ["申号拿ID，下工具，新建配目录", ["平台注册账号", "获取AppID", "安装微信开发者工具", "新建项目并填写目录"], "高频考点：创建流程按顺序背"],
        ["WXML换组件，绑定靠双括，逻辑不用DOM", ["view/text/image替代div/span/img", "双大括号做数据绑定", "wx:if、wx:for做渲染控制", "没有window/document DOM"], "高频考点：WXML与HTML区别常考"],
        ["WXSS多rpx，能import，样式分全局局部", ["rpx适配屏幕", "@import导入样式", "选择器能力有限", "app.wxss全局、页面wxss局部"], "高频考点：rpx几乎必考"],
        ["父设flex成容器，主轴交轴管对齐", ["display:flex", "主轴/交叉轴", "justify-content管主轴", "align-items管交叉轴"], "高频考点：布局题常考"],
        ["载显初隐卸，页面生命周期五步", ["onLoad一次加载", "onShow每次显示", "onReady初次渲染", "onHide隐藏", "onUnload卸载"], "高频考点：函数名和触发时机必背"],
        ["if销毁重建，hidden只显隐", ["wx:if惰性渲染，切换成本高", "hidden始终渲染，切换成本低", "频繁切换用hidden", "条件少变用wx:if"], "高频考点：对比题高发"],
        ["json开刷新，onPull拉数据，stop停动画", ["enablePullDownRefresh开启", "onPullDownRefresh监听", "this.setData更新", "wx.stopPullDownRefresh停止"], "高频考点：实现步骤题"],
        ["距离先配置，触底onReach，分页加锁防重复", ["onReachBottomDistance配置距离", "onReachBottom监听", "拼接新数据", "加loading锁"], "高频考点：上拉加载常考"],
        ["取实例设src，title不填播不动", ["getBackgroundAudioManager获取实例", "src和title是关键", "play/pause/stop/seek控制", "onPlay/onPause/onEnded监听"], "常规考点：会列属性方法即可"],
        ["取上下文，设样式，画路径，draw收尾", ["获取canvas上下文", "设置fill/stroke/font", "moveTo/lineTo/arc绘制", "旧API需要draw"], "常规考点：步骤题"],
        ["选文件upload上，download下，save存open看", ["chooseMedia选文件", "uploadFile上传", "downloadFile下载", "saveFile保存", "openDocument预览"], "常规考点：API名别写错"],
        ["create定参数，链式step，export给页面", ["createAnimation创建", "duration/timingFunction/delay配置", "rotate/scale等链式调用", "step结束，export绑定"], "常规考点：按步骤答"],
        ["Launch一次，Show前台，Hide后台，Error错，NotFound丢", ["onLaunch全局一次", "onShow前台显示", "onHide切后台", "onError脚本/API错误", "onPageNotFound页面不存在"], "高频考点：应用生命周期和页面生命周期要区分"],
        ["connect连，open后发，message收，close关", ["wx.connectSocket发起", "onOpen成功", "send发送", "onMessage接收", "close关闭"], "常规考点：长连接流程"],
        ["navigate保留，redirect关闭，switchTab切底栏", ["navigateTo保留当前页，可返回", "redirectTo关闭当前页", "switchTab跳TabBar并清非Tab页"], "高频考点：页面跳转区别必背"],
        ["login拿code，后台换openid，token本地存", ["wx.login拿临时code", "wx.request发给后台", "后台换openid/session_key", "自定义token返前端并缓存"], "高频考点：登录流程常考大题"]
    ]);
