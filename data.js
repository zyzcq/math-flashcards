...
(function normalizeCatalogForReviewHome() {
  ...
  <div class='sa-item'>
    ...
    <div class='sa-content'>
      ...
      <span class='sa-desc'>① 避免幻觉编造：大模型缺乏图书馆的内部实时信息，容易瞎编借阅规则；② 私密性与实时更新：馆内的具体藏书分布、实时借阅状态均是私有的实时数据，直接询问通用模型无法获得。</span>
    </div>
  </div>
  <div class='sa-item'>
    ...
    <div class='sa-content'>
      ...
      <span class='sa-desc'>学生输入问题（如“怎么借书”） $ightarrow$ 系统把问题做向量化并在本地检索出规则文档 $ightarrow$ 把相关文档和学生原问题合并成提示词发送给大模型 $ightarrow$ 模型阅读文档提炼成口语化答案 $ightarrow$ 返回给学生。</span>
    </div>
  </div>
  <div class='sa-item'>
  ...
  <div class='sa-item'>
    ...
    <div class='sa-content'>
      ...
      <span class='sa-desc'>观众现场扫码 $ightarrow$ 弹出扣子智能体界面 $ightarrow$ 观众输入自然语言问题 $ightarrow$ 智能体先在后台检索知识库 $ightarrow$ 找到对应的瓷器或剪纸资料段落 $ightarrow$ 将段落和问题一同送入大模型提炼回答 $ightarrow$ 文本显示并自动语音播报给观众。</span>
    </div>
  </div>
</div>`
                }
