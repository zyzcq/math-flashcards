...
const appData = {
    ...
    "cards": [
        ...
        },
        {
            ...
            "q": "请结合实验7的设计任务，设计一款“智能设备点检 APP”，并围绕以下四个方面完成系统性设计与分析：\n1. 痛点分析：描述典型传统工作方式，并指出三个核心痛点。\n2. 核心功能定义：明确 APP 名称、使用角色、4 项核心功能的“输入-处理-输出”逻辑，以及与消费级 APP 在数据采集、交互防误和异常处理上的关键差异。\n3. 对比传统方式优势：从效率、准确性、实时性、可追溯性及协同能力维度逐项阐述。\n4. 工业原型设计说明：提供主界面布局规划，说明针对工业严苛现场（如噪音、手套操作等）的交互设计特色。",
